...
class PredictedCompare():
    def __init__(self, path_to_predicted_files, output_folder, db_folder, min_pwms_in_cluster=3, top_n=2,
                 db_type='folder', input_count=1, db_count=0, db_file_type='.txt',
