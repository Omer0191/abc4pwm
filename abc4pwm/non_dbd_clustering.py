...
class non_dbd_ClusteringPwm():
    ...
    def __init__(self, input_folder_path, output_folder_path, path_to_text_report, seed, damp, max_iter,
                 convergence_iter, preference, max_no_processors=5):
        """
    ...
    def clustering(similarityMatrix, seed, damp=0.5, max_iter=800, convergence_iter=45, preference=-50):
        ...
        clusters = AffinityPropagation(damping=damp, max_iter=max_iter, convergence_iter=convergence_iter,
                                       preference=preference, affinity='precomputed', verbose=False,
                                       random_state=seed).fit(similarityMatrix)
...
if __name__ == "__main__":
    clusteringClassobj = non_dbd_ClusteringPwm('ensemble/omer_ensemble/demo_out_ensemble/swi4/demo_in/',
                                               'ensemble/omer_ensemble/out/clustering_out/')
